...
| [ADR-013](./foundation/ADR-013-three-repos-tool-registry-store-and-a-host-binding-outside-the-store.md) | Three repos — tool, registry, store — and a host binding outside the store | Accepted |
